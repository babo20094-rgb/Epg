...
def mk_kanal_finden(kanalname):
    ...
    if aehnliche:
        ...
        # reinen Aehnlichkeits-Score zu riskant: difflib haelt z.B. "K3"
        # und "SK3" (85% Zeichen-Aehnlichkeit) faelschlich fuer denselben
        # Kanal, obwohl es zwei komplett verschiedene mazedonische Sender
        # sind ("K3" vs. "MK - SK 3"/Sport Klub 3 - September 2026 live
        # entdeckt). Ein echtes Kurzform-Match bleibt aber erlaubt, wenn
        # der kurze Name ein reiner PRAEFIX des Treffers ist (oder
        # umgekehrt) - "K3" ist dagegen kein Praefix von "SK3".

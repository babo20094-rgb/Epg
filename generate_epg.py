...
#
# - Steht der Sender bereits in sender.txt, wird dort nur das
#   Logo überschrieben (kein zusätzlicher Eintrag, kein
#   doppelter <channel>-Block).
# - Steht der Sender NICHT in sender.txt, wird nur ein
#   <channel>-Block mit Icon angelegt - OHNE <programme>-
#   Platzhalter, damit das echte EPG dieser Quelle erhalten
#   bleibt.
# ==========================================================

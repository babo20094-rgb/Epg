...
for zeile in logo_only_zeilen:
    ...
    if ist_name_praefix or len(roh_teile) == 2:
        ...
        # b) Kein Treffer in sender.txt: eigenständigen Channel anlegen.
        # Klammerinhalt zusätzlich als Alias ohne Klammern herauslösen,
        # damit der Player mehr Chancen zur Zuordnung per Teilstring hat.
        kanal = voller_name
